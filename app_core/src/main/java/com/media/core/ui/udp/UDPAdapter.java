...
import com.media.core.ui.group.GroupAdapter;

import java.util.ArrayList;
import java.util.List;

public class UDPAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<String> clients;
    private static final List<String> selectClients = new ArrayList<>();

    public UDPAdapter(Context context, List<String> clients) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GroupAdapter.NormalHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        GroupAdapter.NormalHolder normalHolder = (GroupAdapter.NormalHolder) holder;
