...
public class UDPListActivity extends AppCompatActivity implements
        View.OnClickListener{
    private final String SP_CLIENTS_KEY = "SP_CLIENTS_KEY";
    private UDPAdapter doorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doorAdapter = new UDPAdapter(this, clients);
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {//添加"Yes"按钮
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        List<String> strings = SPUtils.getClazz(UDPListActivity.this, SP_CLIENTS_KEY, List.class);
                        if (strings == null) {
                            strings = new ArrayList<>();
                        }
                        if (!strings.contains(roomId)) {
                            strings.add(roomId);
                            SPUtils.putClazz(UDPListActivity.this, SP_CLIENTS_KEY, strings);
                            getClients();
                        }
